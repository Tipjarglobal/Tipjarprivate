...
- FEATURE/FIX (2026-07-09n) LIVE-FRÜH-ABRECHNUNG + Mitglieder-Boost + Produktions-Diagnose.
  ...
  (3) DIAGNOSE-ENDPOINT: neuer GET /api/admin/live-health (require_admin) meldet in EINEM Call: api_football_key_set, is_leader, hq_account_exists, current_live_tips, pending_prematch_tips, API-Football /status (http/errors/requests/plan) und live=all results. Zweck: Produktions-Ursache für "keine Lives" bestimmen ohne Log-Zugriff. Nutzer ruft ihn nach Re-Deploy als Admin auf tipjarglobal.com auf.
