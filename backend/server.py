...
async def seed_showcase():
    ...
    # Purge the tutorial-seed tips + the Häcken parlay (removed per user request) in every env
    for old_id in ["seed-tut-bad", "seed-tut-banker", "seed-tut-live", "seed-hacken-parlay"]:
